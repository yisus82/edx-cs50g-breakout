...
--[[
  ...
  @param {number} level - the level to create bricks for
]]
function LevelMaker:createMap(level)
  ...
  for y = 1, numRows do
    ...
    -- solid tier we'll use if we're not alternating
    ...
    for x = 1, numCols do
      ...
      -- if we didn't skip this iteration, add the brick to the bricks table
